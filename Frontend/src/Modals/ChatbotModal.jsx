...
const ChatbotModal = ({ onClose }) => {
  const [messages, setMessages] = useState([
    ...
    { 
      role: 'system', 
      content: 'You are a helpful AI learning assistant. Provide clear, concise, and informative responses. Remember the context of our previous conversation.' 
    }
  ]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 pointer-events-auto">
      <div className="w-[700px] h-[700px] bg-white rounded-xl shadow-2xl border border-green-200 flex flex-col overflow-hidden">
        {/* Modal Header */}
        <div className="flex justify-between items-center p-4 border-b border-green-200 flex-shrink-0">
          <h2 className="text-xl font-semibold text-green-800">AI Learning Assistant</h2>
          <button 
            onClick={onClose}
