  ...
  const Donations = () => {
    ...
    const calculateStats = () => {
      return {
        ...
        totalAllocated: donations.reduce(
          (sum, d) =>
            d.status === "completed" && d.isAllocated ? sum + d.amount : sum,
          0
        ),
        pendingAllocation: donations.reduce(
          (sum, d) =>
            d.status === "completed" && !d.isAllocated ? sum + d.amount : sum,
          0
        ),
          ...
          >
            ...
            <div className="mt-2 w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${
                    (stats.totalAllocated / stats.totalReceived) * 100 || 0
                  }%`,
                }}
              ></div>
            </div>
